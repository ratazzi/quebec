...
use sea_orm::{DatabaseTransaction, TransactionTrait, DbErr, Set, ActiveValue};
use tracing::{info, error};
use super::solid_queue_ready_executions;
use super::solid_queue_jobs;
...
impl Retryable for Entity {
    async fn retry(&self, txn: &DatabaseTransaction) -> Result<(), DbErr> {
        // 由于 Entity 没有具体的 job_id，这个方法需要不同的实现方式
